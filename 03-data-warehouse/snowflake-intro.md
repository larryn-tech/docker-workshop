...
*Image courtesy of [Snowflake](https://docs.snowflake.com/en/user-guide/intro-key-concepts)*
...
The three primary table types are permanent, temporary, and transient.
...
-- Specify number of seconds of inactivity before automatically suspending warehouse
CREATE WAREHOUSE my_warehouse
